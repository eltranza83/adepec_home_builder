export const portfolioData = [
  {
    ...
    specs: {
      ...
      garage: "415.1 SQ. FT. (2-Car Niche)",
      lotSize: "79' Front x 110' Depth",
      rooms: "4 Bedrooms, 3 Full Baths, 2 Half Baths",
      addressText: "9908 N 25th St"
    },
    features: [
      {
        tagline: "Finishes & Climate",
        title: "Premium Features",
        items: [
          "<strong>Premium Finishes:</strong> Porcelain tile flooring throughout the entire home and showers, paired with custom quartz countertops.",
          "<strong>Exterior Styling:</strong> Built with a stucco exterior and natural Cantera stone accents.",
          "<strong>Climate Systems:</strong> Driven by two separate air conditioning units (7.5 tons total).",
          "<strong>Insulation:</strong> Energy-saving spray foam insulation applied on both the rafters and exterior walls for optimal thermal performance."
        ]
      },
      {
        tagline: "Amenities & Site Details",
        title: "Exterior & Amenities",
        items: [
          "<strong>Gourmet Kitchen:</strong> Includes a dedicated Butler's pantry. Premium appliances are provided: a cooktop, in-cabinet microwave, stove, and a mini fridge.",
          "<strong>Security & Systems:</strong> Equipped with an active alarm system and a lawn sprinkler system.",
          "<strong>Fencing & Gating:</strong> The property comes entirely fenced and enclosed with a secure metal gate.",
          "<strong>Garage Finish:</strong> Completed with a durable epoxy floor coating.",
          "<strong>Driveway & Walkways:</strong> Features a custom stamped and sealed concrete driveway."
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    description: "A clean stucco and white stone sanctuary featuring bespoke entry details, double-height ceilings, and marble-look polished floors throughout.",
    hasSpecs: false,
    gridImages: [
      {
  ...
  },
  {
    ...
    tagline: "Residence II (Sold)",
    description: "Elevated modern interiors with designer pendant lighting, floating vanities, and a geometric glass-enclosed wet shower sanctuary.",
    hasSpecs: false,
    gridImages: [
      {
